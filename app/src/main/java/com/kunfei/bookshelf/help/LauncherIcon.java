...
public class LauncherIcon {
    ...
    private static ComponentName componentNameMain = new ComponentName(MApplication.getInstance(), BuildConfig.APPLICATION_ID + ".view.activity.WelcomeActivity");
    private static ComponentName componentNameBookMain = new ComponentName(MApplication.getInstance(), BuildConfig.APPLICATION_ID + ".view.activity.WelcomeBookActivity");
