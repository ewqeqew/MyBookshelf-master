...
public class ReadBookControl {
    ...
    private void initTextDrawable() {
        if (null == textDrawable) {
            ...
            temp5.put("textColor", Color.parseColor("#929292"));
            temp5.put("bgIsColor", 1);
            temp5.put("textBackground", Color.parseColor("#333333"));
    ...
    public int getBgColor(int index) {
        return preferences.getInt("bgColor" + index, Color.parseColor("#333333"));
    }
