...
public class ReadBottomMenu extends FrameLayout {
    ...
    LinearLayout fabReadAloud;
    @BindView(R.id.fabReadAloudIv)
    ImageView fabReadAloudIv;
    @BindView(R.id.fabAutoPage)
    LinearLayout fabAutoPage;
    @BindView(R.id.fabAutoPageIv)
    ImageView fabAutoPageIv;
    ...
    RelativeLayout llFloatingButton;
...
//        llSetting.setOnClickListener(view -> callback.openMoreSetting());
        llSetting.setOnClickListener(view -> callback.openReadInterface());

        tvReadAloudTimer.setOnClickListener(v -> {
    ...
    public void setFabReadAloudImage(int id) {
        fabReadAloudIv.setImageResource(id);
    }
    ...
    public void setAutoPage(boolean autoPage) {
        if (autoPage) {
            fabAutoPageIv.setImageResource(R.drawable.ic_auto_page_stop);
            fabAutoPage.setContentDescription(getContext().getString(R.string.auto_next_page_stop));
        } else {
            fabAutoPageIv.setImageResource(R.drawable.ic_auto_page);
